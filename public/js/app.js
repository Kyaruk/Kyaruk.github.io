...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      edu_bs_meta: '计算机科学与技术 ｜ GPA 3.67/4.0 ｜ 2019.09 – 2023.06',
      blog_desc: '调研笔记 · 技术随笔 · 生活碎碎念（混合），支持标签分类。',
      blog_note: '写新文章：在 content/blog/ 下新建 .md 文件，或用命令 hugo new blog/文章名.md。',
      pub_heading: '论文',
      patent_heading: '专利与软著',
      pub_note: '提示：朱祖坤 / Zukun Zhu 已加粗；PDF / Code 链接目前是占位 #，拿到地址后替换即可。每张卡片右侧为核心算法 pipeline 图位（矩形），将图放到 static/assets/pubs/ 下对应文件名即可自动显示（支持 .png/.jpg/.pdf/.svg）。',
      status_granted: '已授权',
    ...
    en: {
      ...
      edu_bs_meta: 'Computer Science and Technology · GPA 3.67/4.0 · 2019.09 – 2023.06',
      ...
      pub_note: 'Note: Zukun Zhu is bolded; PDF / Code links are placeholders (#) for now—replace once available. Each card’s right side is a reserved rectangular slot for the core pipeline figure; drop the image into static/assets/pubs/ with the matching filename to display it (supports .png/.jpg/.pdf/.svg).',
